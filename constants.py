...
# paths for LM193
# V0 are the old subckts shared by Triet, V1 are given by Ethan - V0 is used before didiode
LM193_SUBCKT_PRE_RAD_TEMPLATE = exe_tools.read_txt_file("netlists/LM193_new_subckt_Prerad.cir")
LM193_SUBCKT_POST_RAD_TEMPLATE = exe_tools.read_txt_file("netlists/LM193_new_subckt_Postrad.cir")
...
# paths for LM139
# V0 is subckt shared by Ethan and V1 is the one shared by Triet - which is similar to 193, v1 is used before diode
LM139_SUBCKT_PRE_RAD_TEMPLATE = exe_tools.read_txt_file("netlists/LM139_new_subckt_Prerad.cir")
LM139_SUBCKT_POST_RAD_TEMPLATE = exe_tools.read_txt_file("netlists/LM139_new_subckt_Postrad.cir")
