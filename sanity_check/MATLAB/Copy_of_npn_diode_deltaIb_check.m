...
figure
semilogy(TCAD_deltaIB.Ve,TCAD_deltaIB.x4040000000000,':o','Color',Blue,'DisplayName','TCAD delta Ib, f=4e12');
hold on

plot(TCAD_deltaIB.Ve,TCAD_deltaIB.x4040000000000,':o','Color',Green,'DisplayName','TCAD delta Ib, f=4e12');
...
%plot(TCAD_deltaIB.Ve,TCAD_deltaIB.x10000000000000,':o','Color',Green,'DisplayName','TCAD delta Ib, f=1e12');
%plot(Xyce_2diode_1e12.V_1_,Xyce_2diode_1e12.x_I_D1__I_D2__,'--','Color',Yellow,'DisplayName','Xyce 2 diodes, f=1e12');
...
%plot(TCAD_deltaIB.Ve,TCAD_deltaIB.x100000000000000,':o','Color',Green,'DisplayName','TCAD delta Ib, f=1e13');
%plot(Xyce_2diode_1e13.V_1_,Xyce_2diode_1e13.x_I_D1__I_D2__,'--','Color',Yellow,'DisplayName','Xyce 2 diodes, f=1e13');
